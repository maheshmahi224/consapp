...
const AdminDashboard = () => {
  ...
  return (
    <div className="p-4 sm:p-6 space-y-6 max-w-full overflow-x-hidden">
      {/* Welcome Section */}
      <div className="bg-gradient-to-r from-primary-600 to-primary-400 rounded-lg shadow-lg p-4 sm:p-6 text-white">
        <h1 className="text-xl sm:text-2xl md:text-3xl font-bold break-words">
          Welcome, SANTHOSH KUMAR THOTA! 👋
        </h1>
              ...
              {stats?.topPerformers?.length === 0 ? (
                ...
                stats?.topPerformers?.map((student, index) => (
                  <tr key={student._id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                    ...
                    <td className="px-3 sm:px-6 py-4 text-xs sm:text-sm text-gray-900 dark:text-white hidden md:table-cell">
                      {student.college}
                    </td>
                    ...
                    <td className="px-3 sm:px-6 py-4 whitespace-nowrap">
                      <span className="px-2 py-1 text-xs sm:text-sm font-semibold bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300 rounded-full">
